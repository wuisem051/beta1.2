...
<<<<<<< HEAD
  ...
  const isMiningInfoActive = useMatch(`${basePath}/mining-info`);
  ...
  const isHomeMinersActive = useMatch(`${basePath}/home-miners`);
...
<<<<<<< HEAD
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-2 ${isMiningInfoActive ? 'text-white' : theme.textSoft}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
=======
...
<<<<<<< HEAD
          ...
          <li className="mb-0.5">
            <div
              ...
              className={`flex items-center py-1.5 px-2 rounded-lg text-sm font-medium transition-colors duration-200 cursor-pointer ${
                isMyWalletActive || isWithdrawalsActive
                  ? 'bg-accent text-white'
                  : `${theme.textSoft} hover:${theme.background} hover:${theme.text}`
              }`}
            >
          ...
          <li className="mb-0.5">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-2 ${isMinersActive ? 'text-white' : theme.textSoft}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
              Tienda de Mineros
            </Link>
          </li>
          <li className="mb-0.5">
